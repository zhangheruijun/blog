import{_ as s,c as n,o as a,a as p}from"./app.47e3cb81.js";const m=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"typescript/配置文件/tsconfig.json.md","lastUpdated":1693304145000}'),l={name:"typescript/配置文件/tsconfig.json.md"},e=p(`<p>下面列举一些重要的配置</p><div class="language-json line-numbers-mode"><button title="Copy Code" class="copy"></button><span class="lang">json</span><pre class="shiki dark-plus" tabindex="0"><code><span class="line"><span style="color:#D4D4D4;">{</span></span>
