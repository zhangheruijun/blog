import{_ as s,c as n,o as a,a as e}from"./app.5b8334ac.js";const m=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[{"level":3,"title":"完整流程示例","slug":"完整流程示例","link":"#完整流程示例","children":[]}],"relativePath":"git/sparse-checkout应用/基本用法.md","lastUpdated":1737081387000}'),p={name:"git/sparse-checkout应用/基本用法.md"},l=e(`<p><code>git sparse-checkout</code> 是 Git 的功能之一，用于在不克隆整个代码仓库的情况下，只检出仓库中指定的目录或文件。这对大型仓库（如单体仓库）非常有用，可以显著减少本地磁盘占用并提高操作效率。</p><h3 id="完整流程示例" tabindex="-1">完整流程示例 <a class="header-anchor" href="#完整流程示例" aria-hidden="true">#</a></h3><div class="language- line-numbers-mode"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki dark-plus" tabindex="0"><code><span class="line"><span style="color:#D4D4D4;"># 克隆仓库</span></span>
